...
public class Week04StringBuilderListSetMapLab {
	...
	public static void main(String[] args) {
		...
		// Strings are immutable. Variable cannot be changed. When concatenated, we create
		// a new string in memory taking space.
		...
		// 		Note:  make sure no dash appears at the end of the StringBuilder
				...
				List<String> swapped = swapFirstToLast(strings);
				...
				List<String> resultList = converSetToList(set);
			...
			// Method 11:
			public static List<String> converSetToList(Set<String> set) {
			...
			// Method 4:
			public static List<String> swapFirstToLast(List<String> list) {
